                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-start justify-start pt-10 pr-5 pb-10 pl-5 md:px-10 bg-white shadow-2xl rounded-xl relative z-10">
                                ...
                                <div className="w-full mt-6 relative space-y-8">
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className='mt-5 p-2 text-secondary justify-center items-center flex text-4xl w-full bg-primary rounded-lg transition duration-200 hover:bg-gray-950 ease'><span className='text-xl'>Sign In With</span><FcGoogle /><span className='font-bold font-serif'>OOGLE</span></div>
