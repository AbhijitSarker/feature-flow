                    ...
                    <form>
                        <div className=' font-medium space-y-10'>
                            ...
                            <div className="relative">
                                <p className="section-bg pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-headingText absolute">Title</p>
                                <input
                                    id="title"
                                    type="text"
                                    required
                            ...
                            <div className="relative">
                                <p className="section-bg pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-headingText absolute">Description</p>
                                <textarea
                                    className=" focus:shadow-xl border text-headingText placeholder-gray-400 focus:outline-none focus:border-gray-500 w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-transparent border-gray-700 rounded-md"
